...
import 'package:console/day_4_part_2.dart' as day_4_part_2;
void main(List<String> arguments) async {
  ...
  print('day 4 part 2 solutions: ${day_4_part_2.wordSearch(await day_4_part_2.readFileToList('C:/DEV/dart-practice/console/input/day4.txt'))}'); // 1864
}
